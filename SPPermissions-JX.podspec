Pod::Spec.new do |s|
  ...
  s.name = "SPPermissions-JX"
  s.version = "6.7.0-v1"
  s.summary = "Ask permissions on Swift. Available List, Dialog & Native interface. Can check state permission."
  s.homepage = "https://github.com/tospery/SPPermissions-JX"
  s.source = { :git => "https://github.com/tospery/SPPermissions-JX.git", :tag => s.version }
  ...
  s.subspec 'Camera' do |subspec|
    subspec.dependency 'SPPermissions-JX/Core'
